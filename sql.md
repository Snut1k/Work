...
values (6,3, 3000)
~~~
'(id, products, sum)'- эту часть можно не писать
...
~~~
Можно задавать поля чтобы они не быи равны NULL
~~~
create table cars(
 id int NOT NULL,
...
insert into users
 ...
 Datetime  округляет время, если имеются лишние цифры. При последующем увелицении параметра или при внесении только даты без времени все незаполненные знаки ставятся как 0. (3.7)
##  (3.9)
##  (3.10)
##  (3.11)
##  (3.12)
